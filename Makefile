...
all: main.o set_asound.o set_battery.o set_hwmon.o set_nvidia.o set_pause.o set_time.o set_wlan.o
	$(CC) $(LIBS) main.o set_asound.o set_battery.o set_hwmon.o set_nvidia.o set_pause.o set_time.o set_wlan.o -o i3barout
